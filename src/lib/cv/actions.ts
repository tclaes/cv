...
export async function saveJob(raw: unknown) {
  await assertAdmin();
...
export async function saveProject(raw: unknown) {
  await assertAdmin();
...
export async function saveCertification(raw: unknown) {
  await assertAdmin();
...
export async function saveSkillCategory(raw: unknown) {
  await assertAdmin();
...
export async function deleteSkillCategory(category: string) {
  await assertAdmin();
